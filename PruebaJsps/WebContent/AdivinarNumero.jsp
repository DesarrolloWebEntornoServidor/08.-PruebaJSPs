...
<html>
	...
	<%-- Se importa la clase BeanAdivinarNumero, ubicada en el paquete paqueteBeans --%>  
	      
	<%@ page import = "paqueteBeans.BeanAdivinarNumero" %>
	...
	<jsp:useBean id="adivinarNumero" class="paqueteBeans.BeanAdivinarNumero" scope="session" />
